...
class BulletizeText(dspy.Signature):
    ...
    **Remember:** Apply the chosen style in titles, headings, bullets, and summaries.
...
def BulletizeTextWithStyle(style="default"):
    ...
    # Prepend the selected style as the primary role at the very top.
    chosen = styles.get(style, styles["default"])
    style_block = f"**Style Guidelines**\n{chosen}\n\n"
    full_doc = style_block + base_doc
